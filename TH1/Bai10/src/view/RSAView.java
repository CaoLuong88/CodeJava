...
public class RSAView extends JFrame {
	...
	public RSAView() {
		...
		Border keyBorder = new TitledBorder(new LineBorder(Color.gray), "Trình tạo khóa", TitledBorder.LEFT,
				TitledBorder.CENTER);
		...
		JLabel privateKeyGenLabel = new JLabel("Khóa bí mật");
		...
		JLabel publicKeyGenLabel = new JLabel("Khóa công khai");
		...
		JLabel numberOfCharLabel = new JLabel("Bạn muốn mã hóa bao nhiêu ký tự ?");
		...
		JButton keyGenButt = new JButton("Tạo ra");
		...
		JButton setEKeyButt = new JButton("Đặt khóa mã hóa");
		...
		JButton setDKeyButt = new JButton("Đặt khóa giải mã");
		...
		Border encryptBorder = new TitledBorder(new LineBorder(Color.gray), "Mã hóa", TitledBorder.LEFT,
				TitledBorder.CENTER);
		...
		JLabel ePublicKeyLabel = new JLabel("Khóa công khai");
		...
		JLabel ePlainLabel = new JLabel("Văn bản:");
		...
		JLabel eCipherLabel = new JLabel("Văn bản mật mã :");
		...
		JButton encryptButt = new JButton("Mã hóa");
		...
		JButton eSetButt = new JButton("Đặt văn bản mật mã");
		...
		Border decryptBorder = new TitledBorder(new LineBorder(Color.gray), "Giải mã", TitledBorder.LEFT,
				TitledBorder.CENTER);
		...
		JLabel dKeyLabel = new JLabel("Khóa bí mật");
		...
		JLabel dCipherLabel = new JLabel("Văn bản mật mã:");
		...
		JLabel dPlainLabel = new JLabel("Văn bản:");
		...
		JButton decryptButt = new JButton("Giải mã");
		...
		JButton dSetButt = new JButton("Đặt văn bản");
