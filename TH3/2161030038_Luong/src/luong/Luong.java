...
//        rdThemNam.setSelected(true);        
        txtXoaHoTen.setText("");
        rdXoaNam.setSelected(true);
    }
    /**
    ...
    private void initComponents() {
        ...
        jLabel5.setForeground(new java.awt.Color(255, 51, 51));
        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel5.setText("XÓA THÔNG TIN CÁ NHÂN");

        jLabel6.setText("Họ và tên:");

        jLabel7.setText("Giới tính");

        bgGioiTinh.add(rdXoaNam);
        rdXoaNam.setText("Nam");

        bgGioiTinh.add(rdXoaNu);
        rdXoaNu.setText("Nữ");
...
int chisodong=-1;
    ...
    private void btXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btXoaActionPerformed
        ...
        if (gioiTinh.equals("Nam")) {
            rdXoaNam.setSelected(true); // Chọn radio "Nam"
        } else {
            rdXoaNu.setSelected(true); // Chọn radio "Nữ"
        }
